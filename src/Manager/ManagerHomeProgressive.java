...
public class ManagerHomeProgressive extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap(8598, Short.MAX_VALUE))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            pst = conn.prepareStatement("SELECT cust_id ,reason, detailed_desc,company_name FROM claimtable where cust_id = ? and company_name = 'Progressive'");
            pst.setString(1,cit);
        ...
        try {
            ...
            pst1 = conn.prepareStatement("DELETE FROM claimtable where cust_id = ? and company_name = 'Progressive'");
