...
public class SalesHomePage_1 extends javax.swing.JFrame {
 Connection conn;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Please enter your Salesman Id in order to know ");

        jLabel8.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel8.setText("the commission you earned.");
        ...
        jLabel18.setText("Comission Detector");
...
//        System.out.println(c.get(0).getCommission());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesHomePage_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesHomePage_1().setVisible(true);
            }
        });
    }
