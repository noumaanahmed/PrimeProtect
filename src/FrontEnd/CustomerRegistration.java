...
//    final String stringDate = dateFormat.format(DOB);
        ...
        for (int i =0; i < log.size();i++) {
         ...
         int m = (person.size()-1);
            ...
            pst= conn.prepareStatement("INSERT INTO CustomerRegistration(cust_id,fname,lname,street_address,state,zip_code,city,gender,phone, username,pass,email)VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
