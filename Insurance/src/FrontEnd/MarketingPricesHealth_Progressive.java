 ...
 */
public class MarketingPricesHealth_Progressive extends javax.swing.JFrame {
     ...
     */
    public MarketingPricesHealth_Progressive() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int bipolar = Integer.parseInt(bipolarDisorder);
         ...
         try {
            ...
            pst1 = conn.prepareStatement("update HealthPricing set base_premium = ?,tobacco_no =?,tobacco_yes = ?, child_no = ?, child_yes = ?,cancer = ? ,heart_patient =?,AIDS_HIV =?,renal_kidney_failure = ?,bipolar_disorder =? WHERE company = 'Progressive'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            pst = conn.prepareStatement("SELECT company,base_premium,tobacco_no,tobacco_yes,child_no,child_yes,cancer,heart_patient,AIDS_HIV,renal_kidney_failure,bipolar_disorder FROM HealthPricing where company = 'Progressive'");
            rs = pst.executeQuery();
            while(rs.next())
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarketingPricesHealth_Progressive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MarketingPricesHealth_Progressive().setVisible(true);
            }
        });
    }
