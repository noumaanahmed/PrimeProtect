...
public class Financerapproved {
    ...
    private static Message prepareMessage (Session session, String myAccountEmail, String recepient) {
        try{
            ...
            message.setSubject("Claim settled");
            message. setText ("Congratulations user! Your claim has been settled by the finance department.");
        return message;
        } catch (Exception ex) {
